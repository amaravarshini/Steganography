...
public boolean extract() {
    ...
    System.out.println("Extracting the encrypted text from the audio file ...");

    System.out.println("The audio bytes before extracting the encrypted message length: "
                    + audioBytes.length);
...
{
	System.out.println("Decrypting the cipher message: " + new String(cipherText));
	System.out.println("The cipher message size is: " + cipherText.length);
	System.out.println("The decryption password length: " + password.length);
		...
		try {
			...
			try {
				...
				System.out.println("The decrypted message length: " + plainText.length);
